...
const createTaskTemplate = (task) => {
  const {description: notSanitizedDescription, dueDate, repeatingDays, color, isFavorite, isArchive} = task;
  ...
  const classRepeat = Object.values(repeatingDays).some((it) => !!it) ? `card--repeat` : ``;
